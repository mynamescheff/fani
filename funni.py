...
def move_away(event):
    ...
    new_x = max(0, min(root.winfo_screenwidth() - root.winfo_width(), x + random.randint(-100, 100)))
    new_y = max(0, min(root.winfo_screenheight() - root.winfo_height(), y + random.randint(-100, 100)))
